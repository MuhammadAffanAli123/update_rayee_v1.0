...
export default (props) => {
    ...
    return(
        <Container>
            ...
            <Content style={{ backgroundColor:'#03fcf8'}}>
                <FadeInAnim>
                <Grid style={{backgroundColor:'white', height:220 , width:"96%" , marginLeft:8.5}}>
                    ...
                    <Button transparent onPress={() => setType({ ...type, loading:true, cat:'name', title:'Edit Name' })}>
                        <Text style={{ fontSize:26, color:'black', textTransform:'capitalize'}}>{user.fname+' '+user.lname+' '}
          ...
          <Card>
            <CardItem header>
                    ...
                    {!load ?
                    <Text style={{paddingRight:10, fontSize:15 , }}>{user.email}</Text>
                    : null }
                    </Col>
            </CardItem>
            ...
            <Col style={{alignItems:'flex-start', justifyContent:'center', width:100}}>
                    ...
                    {!load && user.phoneveri == 1 ? null : 
                        <Button small primary  style={{backgroundColor:"black" , }} onPress={() => props.navigation.navigate('Phone')}>
                            <Text>Verify Phone</Text>
                        </Button>
                    }

                    <Text style={{paddingRight:15, fontSize:15 , color:'black'}}>{user.phone}</Text>
                    </View>
                    : null }
                    </Col>
            </CardItem>
            ...
            <CardItem header>
                    <Col style={{alignItems:'flex-start', justifyContent:'center', width:100}}>
                    <Text style={{fontSize:15 ,}}>Mobile Network</Text>
                    </Col>

                    <Col style={{alignItems:'flex-end', justifyContent:'center'}}>
                    {!load ?
                    <Text style={{paddingRight:10, fontSize:15 , }}>{user.network}</Text>
                    : null }
                    </Col>
            </CardItem>
            ...
            <Col style={{alignItems:'flex-start', justifyContent:'center', width:100}}>
                    ...
                    {!load ?
                    <View style={{ flex:1,flexDirection:'row-reverse'}}>
                    <Text style={{paddingRight:15, fontSize:15, color:'black'}}>{user.dob}</Text>
                    </View>
                    : null }
                    </>
                    }
            ...
            <CardItem header>
                    ...
                    <Col style={{alignItems:'flex-end', justifyContent:'center'}}>
                    {!load ?
                    <Text style={{paddingRight:10, fontSize:15}}>{user.gender}</Text>
                    : null }
                    </Col>
            </CardItem>
