    ...
    return(
        <Container>
            ...
            <Content style={{ backgroundColor:'white'}}>
                <FadeInAnim>
                <Grid style={{backgroundColor:'whitw' , width:"96%" , marginLeft:8.5}}>
                    <View style={{justifyContent:"center", alignItems:"center"}}>
                    <Text style={{color:"blue" , }}>Please verify Your Mobile Number</Text>
                    </View>
                   
                </Grid>

                <Content style={{ paddingLeft:5, paddingRight:5 ,  width:"100%"}}>
          <Card>
            <CardItem header>
                    ...
                    {!load ?
                    <Text style={{paddingRight:10, fontSize:15 , fontWeight:"bold"}}>{user.email}</Text>
                    : null }
                    </Col>
            </CardItem>
            ...
            <Col style={{alignItems:'flex-start', justifyContent:'center', width:100}}>
                    ...
                    {!load && user.phoneveri == 1 ? null : 
                        <Button small primary  style={{backgroundColor:"#03fcf8" , fontWeight:"bold"}} onPress={() => props.navigation.navigate('Phone')}>
                            <Text>Verify Phone</Text>
                        </Button>
                    }

                    <Text style={{paddingRight:15, fontSize:15 , fontWeight:"bold", color:'blue'}}>{user.phone}</Text>
                    </View>
                    : null }
                    </Col>
            </CardItem>

            <Divider style={{ backgroundColor: '#333333', marginRight:12, marginLeft:12  , fontWeight:"bold"}} />

            <CardItem header>
                    <Col style={{alignItems:'flex-start', justifyContent:'center', width:100}}>
                    <Text style={{fontSize:15 , fontWeight:"bold"}}>Mobile Network</Text>
                    </Col>

                    <Col style={{alignItems:'flex-end', justifyContent:'center'}}>
                    {!load ?
                    <Text style={{paddingRight:10, fontSize:15 , fontWeight:"bold"}}>{user.network}</Text>
                    : null }
                    </Col>
            </CardItem>
            ...
            <Col style={{alignItems:'flex-start', justifyContent:'center', width:100}}>
                    ...
                    <>
                    {!load ?
                    <View style={{ flex:1,  fontWeight:"bold",flexDirection:'row-reverse'}}>
                    <Text style={{paddingRight:15, fontSize:15, color:'blue'}}>{user.dob}</Text>
                    </View>
                    : null }
                    </>
                    }
                    {visibility && option == 'dob' &&
                    <Item style={{borderStyle:'solid', width:'100%', fontWeight:"bold", borderColor:'#000'}}>
                        <DatePicker
                        style={{width: '100%'}}
                        date={date}
                        mode="date"
            ...
            <CardItem header>
                    ...
                    <Col style={{alignItems:'flex-end', justifyContent:'center'}}>
                    {!load ?
                    <Text style={{paddingRight:10, fontSize:15, fontWeight:"bold"}}>{user.gender}</Text>
                    : null }
                    </Col>
            </CardItem>
            ...
            <Divider style={{ backgroundColor: '#333333', marginRight:12, marginLeft:12, marginBottom:5 }} />
                ...
                > 
                <Icon style={{ color:'#f21010', fontSize:15 }} name='md-close-circle'/>
                </Button>
                </Col>
