...
export default (props) => {
    ...
    return(
        <Container>
            ...
            {/* <Head title='Please fill this Option' toggle={props.navigation.toggleDrawer}/> */}
            { load && 
            <Overlay
                    isVisible={true}
            ...
            <Content style={{ backgroundColor:'#e3edf4'}}>
                <FadeInAnim>
                <Content style={{ backgroundColor:'#18e6af' }}>
              
              </Content>
              <View style={{ backgroundColor:"#18e6af" ,  justifyContent: 'center',alignItems: 'center',}}>
                  <Text style={{marginTop:50, color:"blue",fontWeight:"bold", fontSize:25, backgroundColor:"#18e6af"}}>PLEASE FILL THE ABOVE FIELD </Text>
              </View>
                <Content style={{ paddingLeft:5, paddingRight:5 ,marginTop:30}}>
          <Card>
            ...
            <Col style={{alignItems:'flex-start', justifyContent:'center', width:80}}>
                    <Text style={{fontSize:15, color:'black' , fontWeight:"bold"}}>Education</Text>
                    </Col>
                    ...
                    <Text  style={{paddingRight:15,   fontSize:15, textAlign:'right'}}>{user.education.edu_title}</Text>
                    </View>
                    : null }
                    </>
                    }
            ...
            >
            <Col style={{alignItems:'flex-start', justifyContent:'center', width:80}}>
                    <Text style={{fontSize:15,color:'black'}}>Occupation</Text>
                    </Col>
                    ...
                    {!load ?
                    <View style={{ flex:1, flexDirection:'row-reverse'}}>
                    <Text  style={{paddingRight:15, fontSize:15, textAlign:'right'}}>{user.occupation.occ_title}</Text>
                    </View>
                    : null }
                    </>
                    }
            ...
            <Col style={{alignItems:'flex-start', justifyContent:'center', width:100}}>
                    <Text style={{fontSize:15, color:'black'}}>Marital Status</Text>
                    </Col>
                    ...
                    {!load ?
                    <View style={{ flex:1, flexDirection:'row-reverse'}}>
                    <Text  style={{paddingRight:15, fontSize:15, textAlign:'right'}}>{user.marital_status}</Text>
                    </View>
                    : null }
                    </>
                    }
            ...
            <Col style={{alignItems:'flex-start', justifyContent:'center', width:80}}>
                    <Text style={{fontSize:15, color:'black'}}>Children</Text>
                    </Col>
                    ...
                    <Text style={{paddingRight:18, fontSize:15,}}>{user.children}</Text>
                    </View>
                    : null }
                    </>
                    }
            ...
            <Col style={{alignItems:'flex-start', justifyContent:'center'}}>
                    <Text style={{fontSize:15, color:'black'}}>Children Group</Text>
                    </Col>
            ...
            <Col style={{alignItems:'flex-start', justifyContent:'center'}}>
                    <Text style={{fontSize:15, color:'black'}}>Children Household</Text>
                    </Col>
                    ...
                    {!load ?
                    <View style={{ flex:1, flexDirection:'row-reverse'}}>
                    <Text style={{paddingRight:15, fontSize:15,}}>{user.child_household.child_household_title}</Text>
                    </View>
                    : null }
                    </>
                    }
        ...
        <CardItem header button onPress={() => {
            ...
            <Col style={{alignItems:'flex-start', justifyContent:'center', width:115}}>
                    <Text style={{fontSize:15, color:'black'}}>Purchasing Role</Text>
                    </Col>
                    ...
                    {!load ?
                    <View style={{ flex:1, flexDirection:'row-reverse',textAlign:'right'}}>
                    <Text   style={{paddingLeft:10, fontSize:15,}}>{user.role_purchase.role_title}</Text>
                    </View>
                    : null }
                    </>
                    }
            ...
            <Divider style={{ backgroundColor: '#333333', marginRight:12, marginLeft:12, marginBottom:5 }} />
                ...
                <Text style={{ fontSize:15, fontWeight:'400', color:'#000000'}}>{title}</Text>
                </Col>
        ...
        <Button   rounded bordered   onPress={()=>{props.navigation.navigate('Home')}} style={{ width: '80%', justifyContent: 'center',backgroundColor:"#18e6af", alignItems: 'center', borderColor: '#ffffff' }} >
        
        <Text onPress={()=>{props.navigation.navigate('Home')}}  style={{ borderBottomWidth: 1,borderBottomColor:"#18e6af", color: 'white',fontWeight:"bold",justifyContent: 'center', alignItems: 'center' }}>Next</Text>
