    ...
    <Container>
        ...
        {!load ? (
            <Content style={{ paddingLeft: 10, paddingRight: 10, backgroundColor: '#ededed' }}>
                ...
                <Row style={{
                    paddingLeft: 20, paddingRight: 20, marginTop: 20, backgroundColor: '#18e6d1',
                ...
                <Row style={{
                    paddingLeft: 20, paddingRight: 20, marginTop: 0, backgroundColor: '#18e6d1',
                ...
                {question[current].questionType == 'image' &&
                    <View style={{ flex:1, justifyContent:'center', alignItems:'center', backgroundColor:'#18e6d1'}}>
                    <Image
